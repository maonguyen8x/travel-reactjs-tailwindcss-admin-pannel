...
export const BoxPageStay = styled(BoxShadownCard)`
  margin-bottom: 20px;
  padding-bottom: 10px;
  i {
    cursor: pointer;
...
export const BoxCustomPageStay = styled(BoxShadownCard)`
  height: 100%;
  .box-image {
    margin: 11px;
    .image {
...
export const BoxInformationPageStay = styled.div`
  display: flex;
...
export const BoxSocialPageStay = styled.div`
  display: flex;
  justify-content: space-between;
`;
...
export const DetailCreator = styled(DeContent)`
  font-style: italic;
  color: #1e9ae9;
  cursor: pointer;
  &:hover {
